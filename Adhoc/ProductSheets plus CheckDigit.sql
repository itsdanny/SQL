...
DECLARE @CHAR INT
DECLARE @LeftPart VARCHAR(5) = '00000'
...
PRINT 'START'
  WHILE @Row < 9999
	...
	VALUES (RIGHT(@LeftPart+CAST(@Row AS VARCHAR(5)),5) + ''+(SELECT CheckDigit1 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+1 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit2 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+2 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit3 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+3 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit4 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+4 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit5 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+5 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit6 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+6 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit7 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+7 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit8 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+8 AS VARCHAR(5)),5) + ''+(SELECT CheckDigit9 FROM @Results),
			RIGHT(@LeftPart+CAST(@Row+9 AS VARCHAR(5)),5) + ''+(SELECT CheckDigitX FROM @Results),
			@Sheet)		
	SET @Row = @Row + 10
  END
